...
This project provides “contextualization” scripts for https://alpinelinux.org[Alpine Linux] and https://gentoo.org[Gentoo] (with OpenRC) virtual machines running on http://opennebula.org[OpenNebula].
